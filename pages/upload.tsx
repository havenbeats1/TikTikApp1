...
const handlePost = async () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-8 lg:pt-10 bg-[#F8F8F8] xs: justify-center'>
        <div className='bg-white rounded-lg xl:h-[80vh] w-[70%] flex gap-6 flex-wrap justify-center items-center p-14 pt-6'>
            <div>
                <div>
                    ...
                    >
                        {topics.map((topic) => (
                            ...
                            <div className="flex gap-6 mt-10">
                                ...
                                onClick={handlePost}
                                type="button"
                                className='bg-[#F51997] text-white border-2 text-md
                                font-medium p-2 rounded w-28 lg:w-44 outline-none'
                                >
                                    Post
                                </button>
